...
public class UserAuthenticationServiceImpl implements UserAuthenticationService {
	 ...
	 */
	@Autowired
	UserAutheticationRepository  autheticationRepository;

	public UserAuthenticationServiceImpl(UserAutheticationRepository repository) {
		this.autheticationRepository = repository;
	}
	...
	public User findByUserIdAndPassword(String userId, String password) throws UserNotFoundException {
		User user=autheticationRepository.findByUserIdAndUserPassword(userId, password);
		if(user ==null) {
	...
	public boolean saveUser(User user) throws UserAlreadyExistsException {
		...
		Optional<User> u = autheticationRepository.findById(user.getUserId());
		if (u.isPresent()) {
